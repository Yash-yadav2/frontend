...
const [faltuData, setFaltuData] = useState({
  email: "",
  password: "",
});
...
const handleChangeLogin = (e) => {
  setFaltuData({ ...faltuData, [e.target.name]: e.target.value });
};
...
const handleLogin = async (e) => {
  e.preventDefault();
  try {
      const res = await axios.post("/auth/login", faltuData);
