...
export default function AdminPanel() {
  ...
  const [winners] = useState([
    { id: 1, user: "Alice Johnson", prize: "$500", date: "2023-01-03" },
    { id: 2, user: "Bob Williams", prize: "$300", date: "2023-01-04" },
  ]);
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 overflow-y-auto p-6 bg-gray-100">
        ...
        <div className="flex gap-4 mb-6">
          <Button onClick={() => setActiveTab("users")} className={activeTab === "users" ? "bg-blue-600 text-white" : "bg-gray-500"}>
            Users
          </Button>
          <Button onClick={() => setActiveTab("transactions")} className={activeTab === "transactions" ? "bg-blue-600 text-white" : "bg-gray-500"}>
            Transactions
          </Button>
          <Button onClick={() => setActiveTab("winners")} className={activeTab === "winners" ? "bg-blue-600 text-white" : "bg-gray-500"}>
            Winners
          </Button>
        </div>
      ...
      {/* Responsive Transaction Update Modal */}
      {selectedTransaction && (
